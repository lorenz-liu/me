...
Text entry is indispensable; notwithstanding, in virtual reality, an efficient and handy text entry method is still wanted. Therefore, we propose an innovative one-handed text entry method to achieve a faster speed, higher accuracy, and better user experience.